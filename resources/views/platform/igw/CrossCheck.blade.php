...
@section('section-title', 'IGW Main and Summary day wise cross-check')
@section('currentPage', 'IGW cross check')
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('/platform/igw/report/crosscheck') }}" method="post" class="forms-sample">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                       <table class="table text-center table-hover">
                                <thead>
                                <tr>
                                    <th colspan="5">IGW Main Table</th>
                                    <th colspan="3" class="bg-inverse-danger">MainTable - SummaryTable</th>
                                    <th colspan="5">IGW Summary Table</th>
                                </tr>
                                <tr>
                                    <th>SN</th>
                                    <th>Traffic Date</th>
